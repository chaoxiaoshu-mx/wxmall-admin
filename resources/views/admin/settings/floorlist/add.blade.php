...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="/admin/home/floorlist" enctype="multipart/form-data" method="POST">
				        {{ csrf_field() }}           
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>楼层分类ID：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
					<select name="floor_id" class="select">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">楼层分类图：</label>
